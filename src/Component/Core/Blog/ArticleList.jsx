...
import { GetBlogArticlesByCategory, GetBlogAticles } from '../../../Redux/BlogSlice'
...
const ArticleList = () => {
    ...
    useEffect(() => {
        id !== '' && id !== null && id !== undefined ? dispatch(GetBlogArticlesByCategory(id)) : dispatch(GetBlogAticles())
    }, [id])
    // console.log(articles);
    // const numberOfInitialRecords = process.env.REACT_APP_RECORDS_INITIAL_PAGE
    const numberOfInitialRecords = 4
    const numberOfRecordsPage = 2
        ...
        <>
            {
                articles !== null ? (
                    <>
                        {
                            articles?.slice(0, totalRecordsToDisplay).map((item, key) => {
                                return (
                                    <>
                                        <article class="entry" data-aos="fade-up" key={key + 1}>
                                            ...
                                            <div class="entry-img">
                                                ...
                                                <LazyLoad height={414}>
                                                    <img src={`https://restapinodejs.onrender.com/api/blog/image/${item._id}`} alt="" class="img-fluid" />
                                                </LazyLoad>
                                            </div>
                                            ...
                                            <div class="entry-content">
                                                ...
                                                <div class="read-more">
                                                    <Link to={`/blog/${item._id}`}>Continue reading...</Link>
                                                </div>
                                            </div>
            ...
            {
                totalRecordsToDisplay < articles?.length && (
                    <>
